class ProfileCandidate < ActiveRecord::Base
  ...
  attr_accessible :accepted_location, :as => :update_accepted_location
    ...
    if self.accepted_location == 'Cibubur' && self.accepted_location_changed?
      ...
      unless province.nil?
        ...
        if province.quota_for_cibubur == 0
          ProfileCandidate.update_all('accepted_location_choices = 2', ['is_accepted = ? and accepted_location IS NOT NULL and accepted_location_choices = 0', true])
        end
      end
